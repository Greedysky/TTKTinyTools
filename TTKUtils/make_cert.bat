...
"%base%\pvk2pfx.exe" -pvk %temp%\CbipSetupKey.pvk -spc %temp%\CbipSetupKey.spc -f -pfx %userprofile%\Desktop\TTKTinyTools.pfx
"%base%\signtool.exe" sign /f %userprofile%\Desktop\TTKTinyTools.pfx  /t "http://time.certum.pl/" /d "TTKTinyTools" %1

del %temp%\CbipSetupKey.* >nul 2>nul
del %userprofile%\Desktop\TTKTinyTools.pfx >nul 2>nul
